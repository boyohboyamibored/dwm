...
static const Rule rules[] = {
	...
	{ NULL,       NULL,         "Transmission", 1 << 6,            0,           -1 },
};
...
static const char *sys_actions[] = { "sys_actions", NULL };
...
static const char *backlight_up[] = {"/usr/bin/light", "-A", "10", NULL};
static const char *backlight_down[] = {"/usr/bin/light", "-U", "10", NULL};

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_BackSpace,      spawn,          {.v = sys_actions } },
